    ...
    <section>
      <div className="flex justify-between gap-6 xl:py-12">
        ...
        <div className="xl:w-[564px]">
          <div>
            <h1 className="w-fit border-b-8 border-teal-400">What We Do</h1>
            <p className="py-7 text-zinc-700 text-lg font-medium font-['Manrope']">
              We provide digital solutions that aid with brand growth, flexible
              designs that portray brand value and support systems that
              influence growth and relevance.
            </p>
          </div>
          <div>

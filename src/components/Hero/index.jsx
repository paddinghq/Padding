        ...
        <div className="container mx-auto">
          <div className="flex justify-between gap-6">
            <div className="w-[564px]">
              ...
              <p className="text-zinc-700 text-xl font-thin leading-loose xl:pt-6 xl:pb-12">
              ...
              <button className="bg-neutral-800 text-center text-neutral-50 text-base font-normal font-['Manrope'] p-3 rounded hover:bg-neutral-600 transition-all">
